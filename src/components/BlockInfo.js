...
import { BNT_UNIT } from "../explorer_constants.js";
import {numberWithCommas} from "../helper.js";
import {getBlock, getTransactions} from '../bunkernet-api-client.js';
...
const sompiOrKas = (inp) => {
    ...
    if (parseFloat(inp.toFixed(8)) < 0.00001) {
        ...
        return `${parseFloat(inp.toFixed(8))} {BNT_UNIT}`
    }
}
                            ...
                            <Container className="blockinfo-table mx-0" fluid>
                                <Row className="blockinfo-row">
                                    ...
                                    <Col className="blockinfo-value-mono" lg={10}>{blockInfo.verboseData.hash}
                                        ...
                                        <OverlayTrigger
                                            overlay={<Tooltip id="tooltip-kgi">Open in BunkerNet Graph Inspector</Tooltip>}>
                                            <span>
                                                <BiNetworkChart className="ms-2 copy-symbol" size="20" onClick={() => {
                                                    window.open(`https://kgi.bunkerd.net/?hash=${id}`, '_blank');
                                                }}/>
                                            </span>
                                        </OverlayTrigger>
                                    </Col>
                                        ...
                                        <Row className="utxo-border py-3">
                                                                    ...
                                                                    <Col xs={12} sm={8} md={9} lg={9} xl={8} xxl={7}
                                                                        ...
                                                                        <CopyButton
                                                                            text={getAddrFromOutputs(txInfo[txInput.previousOutpoint.transactionId]["outputs"], txInput.previousOutpoint.index || 0)}/>
                                                                               ...
                                                                               sm={4} md={2}>
                                                                    -{numberWithCommas(getAmountFromOutputs(txInfo[txInput.previousOutpoint.transactionId]["outputs"], txInput.previousOutpoint.index || 0))}&nbsp;{BNT_UNIT}
                                                                </Col></>
                                                                :
                                                                <><Col xs={12} sm={8} md={9} lg={9} xl={8} xxl={7}
                                                                       className="text-truncate">
                                                                    <a className="blockinfo-link"
                                                                       href={`https://katnip.bunkerd.net/tx/${txInput.previousOutpoint.transactionId}`}
                                                                       target="_blank">
                                                                        TX
                                                            ...
                                                            <Col xs={12} sm={8} md={9} lg={9} xl={8} xxl={7}
                                                                ...
                                                                <CopyButton
                                                                    text={txOutput.verboseData.scriptPublicKeyAddress}/>
                                                                       ...
                                                                       md={3}>+{numberWithCommas(txOutput.amount / 100000000)}&nbsp;{BNT_UNIT}</Col>
                                                        </Row>)}
                                                    </Container>
                                                </Col>
                                            </Col>
                                            <Col sm={5} md={4} lg={3}>
                                                ...
                                                <div className="utxo-value d-flex flex-row">
                                                    <div
                                                        className="utxo-amount">{(numberWithCommas(tx.outputs.reduce((a, b) => (a || 0) + parseInt(b.amount), 0) / 100000000))} {BNT_UNIT}
                                                    </div>
                                                </div>
                                            </Col>
                                            {/*<Col sm={3} md={2}>*/}
