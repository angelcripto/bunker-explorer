...
import {getBlockdagInfo, getFeeEstimate, getHashrate, getHashrateMax, getBunkerdInfo} from '../bunkernet-api-client';
import {numberWithCommas} from "../helper";
import {BPS, BNT_UNIT} from "../explorer_constants";
...
const BlockDAGBox = () => {
    ...
    const initBox = async () => {
        ...
        const bunkerdInfo = await getBunkerdInfo()
        ...
        // setMempool(bunkerdInfo.mempoolSize)
        // localStorage.setItem("mempool", bunkerdInfo.mempoolSize)
    }
            ...
            <table style={{fontSize: "1rem"}}>
                ...
                <tr>
                    ...
                    <td className="pt-1 text-nowrap">
                        BUNKERNET {process.env.REACT_APP_NETWORK.toUpperCase()}
                    </td>
                </tr>
                <tr>
                    <td className="cardBoxElement">
                ...
                <tr>
                    ...
                    <td className="pt-1" id="feerateReg">
                        ≈ {feerate > 300 ? (feerate * 3165 / 100000000).toFixed(2) : (feerate * 3165 / 100000000)} {BNT_UNIT}
                    </td>
                </tr>
            </table>
        </div>
