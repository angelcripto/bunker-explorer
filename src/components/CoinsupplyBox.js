...
import {getCoinSupply, getHalving} from '../bunkernet-api-client';
import {API_SERVER, BNT_UNIT} from "../explorer_constants";
        ...
        <div className="cardBox mx-0">
            <table style={{fontSize: "1rem"}}>
                ...
                <tr>
                    ...
                    <td className="">
                        <div id="coins">{numberWithCommas(circCoins)} {BNT_UNIT}
                        </div>
                    </td>
                </tr>
                <tr>
                    <td className="cardBoxElement align-top">Max <span className="approx">(approx.)</span></td>
                    <td className="pt-1">28,700,000,000 {BNT_UNIT}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td className="pt-1">{process.env.REACT_APP_NETWORK === "mainnet" ? `${blockReward} ${BNT_UNIT}` : '-'}</td>
                </tr>
                <tr>
                    ...
                    <td className="pt-1">{process.env.REACT_APP_NETWORK === "mainnet" ? <>{halvingDate}<br/>
                        <div className="text-end w-100 pe-3 pt-1" style={{fontSize: "small"}}>to {halvingAmount} {BNT_UNIT}
                        </div></> : "-"}
                    </td>
                </tr>
            </table>
