...
import {getBlock} from './bunkernet-api-client';
import {ADDRESS_PREFIX, API_SERVER, BNT_UNIT, SOCKET_SERVER, SUFFIX} from "./explorer_constants";
                ...
                <BlueScoreContext.Provider value={{blueScore}}>
                                ...
                                <Container id="navbar-container" fluid>
                                        ...
                                        <Navbar.Brand>
                                            <Link to="/">
                                                <div className="navbar-brand">
                                                    ...
                                                    <div
                                                        className="navbar-brand-text text-start">BUNKERNET<br/>EXPLORER{SUFFIX}
                                                    </div>
                                                </div>
                                            </Link>
                                        </Navbar.Brand>
                                    ...
                                    <Navbar.Collapse id="responsive-navbar-nav">
                                        <Nav className="me-auto">
                                            ...
                                            <Nav.Item><NavLink className="nav-link fs-5" onClick={closeMenuIfNeeded}
                                                               to={`/contracts`}>Contracts</NavLink></Nav.Item>
                                        </Nav>
                                        <div className='ms-auto navbar-price'>${price} <span
                                            className="text-light">/ {BNT_UNIT}</span></div>
                                    </Navbar.Collapse>
                                </Container>
                            </Navbar>
                                        ...
                                        <Form onSubmit={search} className="">
                                            <InputGroup className="mt-4 mb-4 search-box-group">
                                                <Form.Control className="d-inline-block bg-light text-dark shadow-none"
                                                              ...
                                                              placeholder={`Search for ${ADDRESS_PREFIX}address, block, or contract`}/>
                        ...
                        <div className="text-light footerfull d-flex flex-row justify-content-center px-0">
                            <Container className="footer webpage px-sm-5 py-3 text-center madewith" fluid>
                                <Row className="d-none d-sm-block">
                                    <Col>
                                        Made with <font className="fs-5" color="red">♥</font> by BunkerNet developers
                                        <span className="ms-3">
                    <OverlayTrigger placement="left" overlay={<Tooltip id="github">Source code</Tooltip>}>
                      <a className="blockinfo-link" href="https://github.com/lAmeR1/bunker-explorer"
                    ...
                    <OverlayTrigger placement="right" overlay={<Tooltip id="donate">Donation address</Tooltip>}>
                      <Link className="blockinfo-link ms-3"
                            to="/addresses/bnet:qqkqkzjvr7zwxxmjxjkmxxdwju9kjs6e9u82uh59z07vgaks6gg62v8707g73"><BiDonateHeart
                          size="1.3rem"/></Link>
                    </OverlayTrigger>
                    <OverlayTrigger placement="right" overlay={<Tooltip id="github">REST-API server</Tooltip>}>
                      <a className="blockinfo-link ms-3" href="https://api.elbunkerbitcoin.com/" target="_blank"><SiFastapi
                          size="1.3rem"/></a>
                    </OverlayTrigger>
                  </span>
                  ...
                  <span className="ms-2">
                    ...
                    <OverlayTrigger placement="right" overlay={<Tooltip id="github">REST-API server</Tooltip>}>
                      <a className="blockinfo-link ms-2" href="https://api.elbunkerbitcoin.com/" target="_blank"><SiFastapi
                          size="1.1rem"/></a>
                    </OverlayTrigger>
                  </span>
                                    </Col>
